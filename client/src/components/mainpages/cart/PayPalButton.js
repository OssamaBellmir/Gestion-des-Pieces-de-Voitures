...
export default class MyApp extends React.Component {
    render() {
		...
		let currency = 'MA'; // you can set this string from your props or state  
		let total = 1;  // this is the total amount (based on currency) to charge
		// Document on Paypal's currency code: https://developer.paypal.com/docs/classic/api/currency_codes/

		const client = {
			sandbox:    'AZyc-64y6f03t2xSV7FRedaPJzCqDlqZ2vVfQffbfgyp0mrIVecwgpaaaews3QBhrVybmVASEaJXUidE',
